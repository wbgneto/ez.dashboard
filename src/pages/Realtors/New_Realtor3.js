      ...
      <Paper className={classes.paper}>
        <div>
          <div className="backtolist" style={{float:'left'}}>
            <IconButton aria-label="back to list" component={Link} to={"/newrealtor2"}>
        ...
        <Grid container spacing={2} className="marginT">
          <Grid container item spacing={4} className="viewGrid">
          ...
          <Grid item xs={12} className="inputEdit">
            <div>
              ...
              <Button variant="outlined" className="btnStyle btnOn" component={Link} to={"/newrealtor4"} style={{float:'right'}}>Next</Button>
            </div>
          </Grid>
        </Grid>
      </Paper>

...
export default function EditRealtor({showSnackbar, match, history}) {
    ...
    return (
        <div className={classes.root}>
            ...
            <Paper className={classes.paper}>
                ...
                <Grid container spacing={2} className="marginT">
                    ...
                    <Grid item xs={12} md={12} className="marginT">
                        <div>
                            <Button variant="outlined" className="btnStyle" component={Link}
                                    to={"/Realtors"}>Cancel</Button>
                            <Button variant="outlined" className="btnStyle btnOn"
                                    style={{float: 'right'}}
            ...
            >
                <DialogTitle id="alert-dialog-title">{`Remove realtor "${item.name}"?`}</DialogTitle>
                <DialogContent>
